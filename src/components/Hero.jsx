export default function Hero() {
  return (
    <section className="relative z-10 flex min-h-[82vh] flex-col justify-center px-[6%] pt-[60px]">
      <div className="terminal-glow max-w-[640px] overflow-hidden rounded-[10px] border border-border bg-bg-elevated">
      ...
      <h1 className="mt-[34px] text-[clamp(2.2rem,5vw,3.4rem)] font-bold leading-[1.15]">
        Je construis des bases solides.
        <br />
        Direction : l'<span className="text-socle">automatisation</span> & l'IA.
      </h1>

      <p className="mt-4 max-w-[560px] text-[1.05rem] text-text-dim">
      ...
      <div className="badge-dot mt-6 inline-flex w-fit items-center gap-2 rounded-full border border-direction px-4 py-2 font-mono text-[0.82rem] text-direction">
